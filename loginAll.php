...
$request_token = $twitteroauth->getRequestToken('http://enochsystems.mastersoftwaresolutionsindia.com/google/cont/loginAll.php');
...
<div id="login">
 <div class="col6">
	...
	<div class="col6">
	    <a href="<?php echo $url; ?>" id='twlogin' ><img style="height: 36px; width: 178px; margin-left: 7px; margin-top: 19px;" src="TwitterLogin.png"></a>
	</div>
...
if (!empty($verifier) && !empty($token) && !empty($secret)) {
	...
	echo "<td><a href='session_chk.php'>Logout</a></td></tr>";
	echo "</table>";
	//print_r($user_info);
?>
	<script src="http://code.jquery.com/jquery-1.10.2.min.js"></script>
